...
Locus_nonsyn_syn_df <- read.csv("PF3D7_0711200_Pi_nonsyn_syn_estimates_by_country_rowwise_reduced.csv")
...
ggplot(Locus_nonsyn_syn_df_long, aes(x = Country, y = Value, fill = Type)) +
  ...
  labs(
    #title = "Nonsynonymous and Synonymous Nucleotide Diversity in PF3D7_0711200",
    x = "Country",
